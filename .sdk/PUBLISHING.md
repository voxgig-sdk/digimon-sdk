...
|---|---|---|
| `ts/` | @voxgig-sdk/digimon-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/digimon-sdk \
      --repository voxgig-sdk/digimon-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/digimon-sdk` shows it, and
`npm trust revoke @voxgig-sdk/digimon-sdk --id=<id>` removes it.
