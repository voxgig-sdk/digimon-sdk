...
class DigimonNetsimFeature extends DigimonBaseFeature
{
    ...
    private function _simulate(DigimonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DigimonContext $ctx, array $applied): void
    {
        $client = $this->client;
