...
class DigimonProxyFeature extends DigimonBaseFeature
{
    ...
    public function init(DigimonContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DigimonContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
