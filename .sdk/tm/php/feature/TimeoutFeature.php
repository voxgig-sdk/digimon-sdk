...
class DigimonTimeoutFeature extends DigimonBaseFeature
{
    ...
    private function _with_timeout(DigimonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DigimonContext $_ctx, float $ms): void
    {
        $client = $this->client;
