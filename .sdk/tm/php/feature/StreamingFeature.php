...
class DigimonStreamingFeature extends DigimonBaseFeature
{
    ...
    private function _iterate(DigimonResult $result): \Generator
    {
    ...
    private function _streamable(DigimonContext $ctx): bool
    {
