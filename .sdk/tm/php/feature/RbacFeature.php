...
class DigimonRbacFeature extends DigimonBaseFeature
{
    ...
    private function _required(DigimonContext $ctx): ?string
    {
    ...
    private function _reject(DigimonContext $ctx, string $required): void
    {
    ...
    private function _track(DigimonContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
