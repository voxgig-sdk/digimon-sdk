...
// Digimon SDK clienttrack feature
...
class DigimonClienttrackFeature extends DigimonBaseFeature
{
    ...
    public function PostConstruct(DigimonContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Digimon-SDK';
