...
// Digimon SDK utility: fetcher

class DigimonFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DigimonSDK/1.0)';
    ...
    public static function call(DigimonContext $ctx, string $fullurl, array $fetchdef): array
    {
