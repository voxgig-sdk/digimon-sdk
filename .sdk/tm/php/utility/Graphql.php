...
class DigimonGraphql
{
    ...
    // equivalent.
    public static function body(DigimonContext $ctx): mixed
    {
    ...
    public static function errors(DigimonContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
