...
from projectname_sdk.core.control import DigimonControl
...
class DigimonContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, DigimonResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DigimonError(code, msg, self)
