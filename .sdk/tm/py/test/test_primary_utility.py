...
from projectname_sdk import DigimonSDK
from projectname_sdk.core.spec import DigimonSpec
from projectname_sdk.core.result import DigimonResult
from projectname_sdk.core.response import DigimonResponse
from projectname_sdk.core.operation import DigimonOperation
from projectname_sdk.core.error import DigimonError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import DigimonBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DigimonSDK.test(None, None)
        ...
        class TestInitFeature(DigimonBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DigimonBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DigimonSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DigimonSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DigimonSDK.test(None, setup_opts)
