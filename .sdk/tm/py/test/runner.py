...
class DigimonTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DigimonTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DigimonTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DigimonTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
