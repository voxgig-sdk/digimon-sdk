...
class DigimonTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DigimonTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = DigimonTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = DigimonTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
