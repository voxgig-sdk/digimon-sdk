...
func registerSDKWords(r *eng.Registry, client *sdk.DigimonSDK) {
...
func runOp(client *sdk.DigimonSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
