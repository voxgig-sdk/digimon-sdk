...
// Digimon SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DigimonOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DigimonOmni::structfix($now, Struct::undef()))
                        !== json_encode(DigimonOmni::structfix($val, Struct::undef()))) {
