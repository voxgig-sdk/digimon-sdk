...
// Digimon SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DigimonSDK::test)
...
{
    private const SDK_CLASS = 'DigimonSDK';
    ...
    private const SDK_BASE = 'digimon_sdk';
