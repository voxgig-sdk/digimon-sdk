...
class DigimonTestRunner
{
    ...
    {
        $live = self::getenv('DIGIMON_TEST_LIVE');
        $override = self::getenv('DIGIMON_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DIGIMON_TEST_EXPLAIN');
...
class_alias('DigimonTestRunner', 'Runner');
class_alias('DigimonHelpers', 'Helpers');
