...
// Digimon SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DigimonMakeRequest
{
    public static function call(DigimonContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DigimonResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DigimonResponse($fetched);
        } else {
