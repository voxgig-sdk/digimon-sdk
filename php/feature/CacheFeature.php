...
class DigimonCacheFeature extends DigimonBaseFeature
{
    ...
    private function _through(DigimonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
