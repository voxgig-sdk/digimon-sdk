...
class DigimonRatelimitFeature extends DigimonBaseFeature
{
    ...
    private function _acquire(DigimonContext $ctx): void
    {
    ...
    private function _track(DigimonContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
