...
// Digimon SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DigimonTestFeature extends DigimonBaseFeature
{
    ...
    public function init(DigimonContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DigimonContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DigimonContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DigimonContext $ctx, $op, $args): array
    {
