...
class DigimonEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DigimonEntity($this->_client, $opts);
    }

    /**
     * @param Digimon|array $args Digimon data (assoc-array) to store.
     */
    ...
    /**
     * @return Digimon|array The current Digimon data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Digimon fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Digimon fields).
     */
     ...
     *
     * @param DigimonLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DigimonLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Digimon|array The loaded Digimon as an assoc-array at the
     ...
     *
     * @param DigimonListMatch|array|null $reqmatch Match filter (any subset
     *   of Digimon fields) as an assoc-array; DigimonListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Digimon[]|array A list of Digimon items as assoc-arrays at
