...
class SkillEntity
{
     ...
     * Load a single Skill.
     *
     * @param SkillLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SkillLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Skill|array The loaded Skill as an assoc-array at the
