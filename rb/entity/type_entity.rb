...
class TypeEntity
  ...
  #   as an empty match, so client.Type.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Type, Hash] the loaded Type; raises DigimonError on failure
  ...
  #
  # @param reqmatch [TypeListMatch, Hash, nil] match filter (any subset of
  #   Type fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Type>, Array] the matching Type items; raises DigimonError on failure
