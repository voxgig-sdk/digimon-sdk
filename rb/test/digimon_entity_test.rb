...
class DigimonEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    digimon_ref01_list_result, err = digimon_ref01_ent.list(digimon_ref01_match, nil)
    assert_nil err
    ...
    digimon_ref01_data_dt0_loaded, err = digimon_ref01_ent.load(digimon_ref01_match_dt0, nil)
    assert_nil err
