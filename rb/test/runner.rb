...
module DigimonTestRunner
  ...
  def self.env_override(m)
    live = getenv("DIGIMON_TEST_LIVE")
    override = getenv("DIGIMON_TEST_OVERRIDE")
    ...
    explain = getenv("DIGIMON_TEST_EXPLAIN")
    m["DIGIMON_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = DigimonTestRunner
Helpers = DigimonHelpers
Vs = VoxgigStruct
