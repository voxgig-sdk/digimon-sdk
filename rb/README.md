...
The Ruby SDK for the Digimon API — an entity-oriented client using idiomatic Ruby conventions.
...
```
rb/
├── Digimon_sdk.rb       -- Main SDK module
...
The main module (`Digimon_sdk`) exports the SDK class
