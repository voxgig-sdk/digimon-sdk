...
func NewSkillEntity(client *core.DigimonSDK, entopts map[string]any) *SkillEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SkillEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SkillLoadMatch and returns an Skill. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SkillEntity) LoadTyped(reqmatch SkillLoadMatch, ctrl map[string]any) (Skill, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Skill{}, err
	}
	return typedFrom[Skill](res), nil
}
