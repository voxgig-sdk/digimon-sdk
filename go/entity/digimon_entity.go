...
func NewDigimonEntity(client *core.DigimonSDK, entopts map[string]any) *DigimonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DigimonEntity) GetName() string { return e.name }
...
func (e *DigimonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DigimonEntity) Deleted() bool {
	return e.deleted
}


func (e *DigimonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDigimonEntity(e.client, opts)
}

func (e *DigimonEntity) Data(args ...any) any {
...
func (e *DigimonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Digimon; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DigimonEntity) DataTyped(data ...Digimon) Digimon {
	if len(data) > 0 {
		return typedFrom[Digimon](e.Data(asMap(data[0])))
	}
	return typedFrom[Digimon](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Digimon (all fields
// optional at the wire level).
func (e *DigimonEntity) MatchTyped(match ...Digimon) Digimon {
	if len(match) > 0 {
		return typedFrom[Digimon](e.Match(asMap(match[0])))
	}
	return typedFrom[Digimon](e.Match())
}
...
func (e *DigimonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DigimonEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DigimonLoadMatch and returns an Digimon. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DigimonEntity) LoadTyped(reqmatch DigimonLoadMatch, ctrl map[string]any) (Digimon, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Digimon{}, err
	}
	return typedFrom[Digimon](res), nil
}




func (e *DigimonEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DigimonListMatch and returns []Digimon. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DigimonEntity) ListTyped(reqmatch DigimonListMatch, ctrl map[string]any) ([]Digimon, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Digimon](res), nil
}



func (e *DigimonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DigimonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DigimonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DigimonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
