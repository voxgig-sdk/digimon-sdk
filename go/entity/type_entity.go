...
func NewTypeEntity(client *core.DigimonSDK, entopts map[string]any) *TypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TypeEntity) GetName() string { return e.name }
...
func (e *TypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TypeEntity) Deleted() bool {
	return e.deleted
}


func (e *TypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTypeEntity(e.client, opts)
}

func (e *TypeEntity) Data(args ...any) any {
...
func (e *TypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TypeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TypeLoadMatch and returns an Type. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TypeEntity) LoadTyped(reqmatch TypeLoadMatch, ctrl map[string]any) (Type, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Type{}, err
	}
	return typedFrom[Type](res), nil
}




func (e *TypeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *TypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
