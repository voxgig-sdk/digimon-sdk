...
func NewFieldEntity(client *core.DigimonSDK, entopts map[string]any) *FieldEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FieldEntity) GetName() string { return e.name }
...
func (e *FieldEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FieldEntity) Deleted() bool {
	return e.deleted
}


func (e *FieldEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFieldEntity(e.client, opts)
}

func (e *FieldEntity) Data(args ...any) any {
...
func (e *FieldEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *FieldEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FieldEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *FieldEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FieldEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FieldEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FieldEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
