...
func (sdk *DigimonSDK) OptionsMap() map[string]any {
...
func (sdk *DigimonSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DigimonSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DigimonSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DigimonSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DigimonSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DigimonSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DigimonSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DigimonSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DigimonSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DigimonSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
