...
const testSeed = `map[string]any{"entity": map[string]any{"attribute": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "digimon": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "field": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "level": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "skill": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "type": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
