...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/digimon-sdk/releases)) or
...
| `image` | `str` | Image URL for the field |
...
| `translation` | `str` | Translation of the skill name |
