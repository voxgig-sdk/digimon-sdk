# Digimon SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DigimonSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DigimonSDK(...) and DigimonSDK.test(...) become
#      DigimonSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "digimon_sdk"
_SDK_CLASS = "DigimonSDK"
