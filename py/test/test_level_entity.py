...
class TestLevelEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.Level(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.Level(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        level_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(level_ref01_data_dt0_loaded))
