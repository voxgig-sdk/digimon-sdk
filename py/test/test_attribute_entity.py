    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set DIGIMON_TEST_ATTRIBUTE_ENTID JSON to run live")
        client = setup["client"]
        ...
        attribute_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(attribute_ref01_data_dt0_loaded))
...
def _attribute_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("DIGIMON_TEST_ATTRIBUTE_ENTID"))
