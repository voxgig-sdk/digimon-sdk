...
from digimon_sdk.utility import register

# Load features
from digimon_sdk.feature.base_feature import DigimonBaseFeature
from digimon_sdk.features import _has_feature, _make_feature
...
class DigimonSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DigimonUtility()
        self._utility = utility

        from digimon_sdk.config import shared_config
    ...
    def get_utility(self):
        return DigimonUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "DigimonSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DigimonSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Attribute(self, data=None) -> "AttributeEntity":
        ...
        from digimon_sdk.entity.attribute_entity import AttributeEntity
