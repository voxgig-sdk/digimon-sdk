...
function LevelEntity.new(client, entopts)
  entopts = entopts or {}
...
function LevelEntity:get_name()
  return self._name
end


function LevelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LevelEntity.new(self._client, opts)
end
...
function LevelEntity:mark_deleted()
  self._deleted = true
end


function LevelEntity:deleted()
  return true == self._deleted
end


function LevelEntity:data_set(args)
  if args ~= nil then
...
function LevelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LevelEntity:match_set(args)
  if args ~= nil then
...
function LevelEntity:match_get()
...
function LevelEntity:stream(action, args, callopts)
...
function LevelEntity:_run_op(ctx, post_done)
  local utility = self._utility
