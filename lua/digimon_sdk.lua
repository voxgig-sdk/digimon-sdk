...
DigimonSDK._make_feature = _make_feature


function DigimonSDK.new(options)
  local self = setmetatable({}, DigimonSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function DigimonSDK:options_map()
...
function DigimonSDK:get_utility()
  return Utility.copy(self._utility)
end


function DigimonSDK:get_root_ctx()
  return self._rootctx
end


function DigimonSDK:prepare(fetchargs)
...
function DigimonSDK:direct(fetchargs)
...
-- by passing it.
function DigimonSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function DigimonSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "DigimonSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function DigimonSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = DigimonSDK.new(sdkopts)
  sdk.mode = "test"
