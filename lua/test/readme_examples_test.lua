...
-- data to return.
local TEST_SEED = '{ entity = { ["attribute"] = { ["test01"] = { id = "test01" } }, ["digimon"] = { ["test01"] = { id = "test01" } }, ["field"] = { ["test01"] = { id = "test01" } }, ["level"] = { ["test01"] = { id = "test01" } }, ["skill"] = { ["test01"] = { id = "test01" } }, ["type"] = { ["test01"] = { id = "test01" } } } }'
