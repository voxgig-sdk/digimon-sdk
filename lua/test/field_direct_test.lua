...
describe("FieldDirect", function()
  it("should direct-list-field", function()
    local setup = field_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-field", setup.live and "live" or "unit")
  ...
  it("should direct-load-field", function()
    local setup = field_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-field", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function field_direct_setup(mockres)
