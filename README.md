...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/digimon` | `npm install @voxgig-sdk/digimon` |
| Python | `voxgig-sdk-digimon` | `pip install voxgig-sdk-digimon` |
| PHP | `voxgig-sdk/digimon` | `composer require voxgig-sdk/digimon` |
| Golang | `github.com/voxgig-sdk/digimon-sdk/go` | `go get github.com/voxgig-sdk/digimon-sdk/go` |
| Ruby | `voxgig-sdk-digimon` | `gem install voxgig-sdk-digimon` |
| Lua | `voxgig-sdk-digimon` | `luarocks install voxgig-sdk-digimon` |
