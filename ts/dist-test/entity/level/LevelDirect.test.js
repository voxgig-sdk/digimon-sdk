...
(0, node_test_1.describe)('LevelDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-level', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-level', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-level', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-level', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DIGIMON_TEST_LEVEL_ENTID'];
...
//# sourceMappingURL=LevelDirect.test.js.map