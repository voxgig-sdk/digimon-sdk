...
(0, node_test_1.describe)('FieldEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(field_ref01_data_dt0.id === field_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/field/FieldTestData.json');
    ...
    let idmap = transform(['field01', 'field02', 'field03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=FieldEntity.test.js.map