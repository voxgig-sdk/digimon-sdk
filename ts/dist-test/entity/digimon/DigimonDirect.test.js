...
(0, node_test_1.describe)('DigimonDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-digimon', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-digimon', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-digimon', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-digimon', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DIGIMON_TEST_DIGIMON_ENTID'];
...
//# sourceMappingURL=DigimonDirect.test.js.map