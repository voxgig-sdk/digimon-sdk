...
function envOverride(m) {
    if ('TRUE' === process.env.DIGIMON_TEST_LIVE ||
        'TRUE' === process.env.DIGIMON_TEST_OVERRIDE) {
    ...
    m.DIGIMON_TEST_EXPLAIN = process.env.DIGIMON_TEST_EXPLAIN || m.DIGIMON_TEST_EXPLAIN;
    return m;
}
