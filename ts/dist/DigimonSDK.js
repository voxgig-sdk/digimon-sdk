...
exports.SDK = exports.DigimonSDK = exports.DigimonEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
const AttributeEntity_1 = require("./entity/AttributeEntity");
const DigimonEntity_1 = require("./entity/DigimonEntity");
const FieldEntity_1 = require("./entity/FieldEntity");
const LevelEntity_1 = require("./entity/LevelEntity");
const SkillEntity_1 = require("./entity/SkillEntity");
const TypeEntity_1 = require("./entity/TypeEntity");
const node_util_1 = require("node:util");
const Config_1 = require("./Config");
Object.defineProperty(exports, "config", { enumerable: true, get: function () { return Config_1.config; } });
const DigimonEntityBase_1 = require("./DigimonEntityBase");
Object.defineProperty(exports, "DigimonEntityBase", { enumerable: true, get: function () { return DigimonEntityBase_1.DigimonEntityBase; } });
...
class DigimonSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('DigimonSDK: graphql: ' +
    ...
    Digimon(entopts) {
        const self = this;
        return new DigimonEntity_1.DigimonEntity(self, entopts);
    }
    ...
    Field(entopts) {
        const self = this;
        return new FieldEntity_1.FieldEntity(self, entopts);
    }
    ...
    Level(entopts) {
        const self = this;
        return new LevelEntity_1.LevelEntity(self, entopts);
    }
    ...
    Type(entopts) {
        const self = this;
        return new TypeEntity_1.TypeEntity(self, entopts);
    }
...
exports.DigimonSDK = DigimonSDK;
const SDK = DigimonSDK;
exports.SDK = SDK;
//# sourceMappingURL=DigimonSDK.js.map